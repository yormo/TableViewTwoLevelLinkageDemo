...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(selectLeftTableViewWithSection:)]) {
        [self.delegate selectLeftTableViewWithSection:self.productsTableView.indexPathsForVisibleRows.firstObject.section];
    }
}
